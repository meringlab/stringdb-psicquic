...
* edit @docs/psicquic.properties.template@ and put under @/opt/stringdb/v9.1/psicquic.properties@, but make sure it's in sync with @psicquic-indexing-spring-test.xml@
