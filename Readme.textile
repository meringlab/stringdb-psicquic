...
* download the "string.uniprot.ids.txt.gz":http://string.uzh.ch/download/public/string_10_0/string.uniprot.ids.txt.gz and uncompress into @/opt/stringdb/v10.0/@
